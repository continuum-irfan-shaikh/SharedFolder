...
// Source: gitlab.connectwisedev.com/platform/platform-common-lib/src/communication/udp (interfaces: Server)
...
import (
	context "context"
	udp "gitlab.connectwisedev.com/platform/platform-common-lib/src/communication/udp"
