...
```go
import	"gitlab.connectwisedev.com/platform/platform-common-lib/src/cryptomgr"
```
...
import (
	...
	"gitlab.connectwisedev.com/platform/platform-common-lib/src/cryptomgr"
)
...
juno@juno:~/gitlab.connectwisedev.com/platform/platform-common-lib/src$ go run cryptomgr/example/example.go 
