...
//
// Use https://gitlab.connectwisedev.com/platform/Platform-Infrastructure-lib/tree/master/messaging for all kafka connectivity
...
import (
	...
	"gitlab.connectwisedev.com/platform/platform-common-lib/src/kafka/encode"
)
