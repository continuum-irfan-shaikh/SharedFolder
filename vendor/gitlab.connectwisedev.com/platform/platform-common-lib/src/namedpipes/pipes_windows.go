...
import (
	...
	"gitlab.connectwisedev.com/platform/platform-common-lib/src/namedpipes/npipe"
	"gitlab.connectwisedev.com/platform/platform-common-lib/src/namedpipes/winio"
)
