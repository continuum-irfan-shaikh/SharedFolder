...
// Source: gitlab.connectwisedev.com/platform/platform-common-lib/src/messaging (interfaces: Service)
...
import (
	...
	messaging "gitlab.connectwisedev.com/platform/platform-common-lib/src/messaging"
