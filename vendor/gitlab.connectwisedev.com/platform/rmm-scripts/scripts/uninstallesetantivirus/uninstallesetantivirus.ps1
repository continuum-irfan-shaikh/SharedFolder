# $version = '8.0.304.0','8.0.312.0','8.0.319.0' # user input
# 
...
Try {
    ...
    "ESET NOD32 Antivirus","msiexec /X {9CEC1801-DB68-48CE-B74F-5733BBD3F729} /qn /norestart","HKEY_LOCAL_MACHINE\SOFTWARE\Microsoft\Windows\CurrentVersion\Uninstall\{9CEC1801-DB68-48CE-B74F-5733BBD3F729}","ESET NOD32 Antivirus without reboot","4.2.76.0","4.2.76.0","0","0"
    "ESET NOD32 Antivirus","msiexec /X {9CEC1801-DB68-48CE-B74F-5733BBD3F729} /qn","HKEY_LOCAL_MACHINE\SOFTWARE\Microsoft\Windows\CurrentVersion\Uninstall\{9CEC1801-DB68-48CE-B74F-5733BBD3F729}","ESET NOD32 Antivirus with reboot","4.2.76.0","4.2.76.0","1","0"
    "ESET Endpoint Antivirus","msiexec /X {3187B3B0-3620-4459-A983-4403FC481420} /qn /norestart","HKEY_LOCAL_MACHINE\SOFTWARE\Microsoft\Windows\CurrentVersion\Uninstall\{3187B3B0-3620-4459-A983-4403FC481420}","ESET Endpoint Antivirus 5.0.2214 without reboot","5.0.2214.4","5.0.2214.4","0","0"
    "ESET Endpoint Antivirus","msiexec /X {3187B3B0-3620-4459-A983-4403FC481420} /qn","HKEY_LOCAL_MACHINE\SOFTWARE\Microsoft\Windows\CurrentVersion\Uninstall\{3187B3B0-3620-4459-A983-4403FC481420}","ESET Endpoint Antivirus 5.0.2214 with reboot","5.0.2214.4","5.0.2214.4","1","0"
    ...
    "ESET Endpoint Antivirus","msiexec /X {3187B3B0-3620-4459-A983-4403FC481420} /qn /norestart","HKEY_LOCAL_MACHINE\SOFTWARE\Microsoft\Windows\CurrentVersion\Uninstall\{3187B3B0-3620-4459-A983-4403FC481420}","Uninstall ESET Endpoint Antivirus 5.0.2214.4 64 bit","5.0.2214.4","5.0.2214.4 (64 bit)","","64"
    "ESET Endpoint Antivirus","msiexec /X {E45ED219-0786-4576-BCE5-1639B73864AC} /qn /norestart","HKEY_LOCAL_MACHINE\SOFTWARE\Microsoft\Windows\CurrentVersion\Uninstall\{E45ED219-0786-4576-BCE5-1639B73864AC}","Uninstall ESET Endpoint Antivirus 5.0.2214.4 32 bit","5.0.2214.4","5.0.2214.4 (32 bit)","","32"
    "ESET Endpoint Antivirus","msiexec /X {8CD0547B-8CE7-4CAA-A413-A43B2C4D11FF} /qn /norestart","HKEY_LOCAL_MACHINE\SOFTWARE\Microsoft\Windows\CurrentVersion\Uninstall\{8CD0547B-8CE7-4CAA-A413-A43B2C4D11FF}","Uninstall ESET Endpoint Antivirus 5.0.2225.0 64 bit","5.0.2225.0","5.0.2225.0","","64"
    "ESET Endpoint Antivirus","msiexec /X {E0F72657-6B20-496B-A884-1B09453FE7E7} /qn /norestart","HKEY_LOCAL_MACHINE\SOFTWARE\Microsoft\Windows\CurrentVersion\Uninstall\{E0F72657-6B20-496B-A884-1B09453FE7E7}","Uninstall ESET Endpoint Antivirus 5.0.2225.0 32 bit","5.0.2225.0","5.0.2225.0","","32"
    "ESET Endpoint Antivirus","msiexec /X {AC6D818C-8EA0-4C2D-AFF9-9B0FA3E0E105} /qn /norestart","HKEY_LOCAL_MACHINE\SOFTWARE\Microsoft\Windows\CurrentVersion\Uninstall\{AC6D818C-8EA0-4C2D-AFF9-9B0FA3E0E105}","Uninstall ESET Endpoint Antivirus 5.0.2254.0 64 bit","5.0.2254.0","5.0.2254.0","","64"
    "ESET Endpoint Antivirus","msiexec /X {B654805A-15D7-4CB3-AB70-EF6A321DB2F9} /qn /norestart","HKEY_LOCAL_MACHINE\SOFTWARE\Microsoft\Windows\CurrentVersion\Uninstall\{B654805A-15D7-4CB3-AB70-EF6A321DB2F9}","Uninstall ESET Endpoint Antivirus 5.0.2254.0 32 bit","5.0.2254.0","5.0.2254.0","","32"
    "ESET Endpoint Antivirus","msiexec /X {6B0C987E-EED3-4D07-828E-FCE96B14BD5C} /qn /norestart","HKEY_LOCAL_MACHINE\SOFTWARE\Microsoft\Windows\CurrentVersion\Uninstall\{6B0C987E-EED3-4D07-828E-FCE96B14BD5C}","Uninstall ESET Endpoint Antivirus 5.0.2126.0 32 bit","5.0.2126.0","5.0.2126.0","","32"
    "ESET Endpoint Antivirus","msiexec /X {FF8AC853-B984-4C9A-937A-1F20FB6AA6B9} /qn /norestart","HKEY_LOCAL_MACHINE\SOFTWARE\Microsoft\Windows\CurrentVersion\Uninstall\{FF8AC853-B984-4C9A-937A-1F20FB6AA6B9}","Uninstall ESET Endpoint Antivirus 5.0.2126.0 64 bit","5.0.2126.0","5.0.2126.0","","64"
    ...
    "ESET Endpoint Security","msiexec.exe /x {`-ED35-4234-BDFF-09662A68D870} /qn","HKEY_LOCAL_MACHINE\SOFTWARE\Microsoft\Windows\CurrentVersion\Uninstall\{677F552D-ED35-4234-BDFF-09662A68D870}","ESET Endpoint Security 6.6.2052.0 with reboot (32 Bit)","6.6.2052.0","6.6.2052.0","1","32"
...
"@ -replace 'HKEY_LOCAL_MACHINE', 'HKLM' -replace "msiexec.exe ", ''
  
    $data = $data | ConvertFrom-Csv | Where-Object {$_.AppVersion -eq $version -and $_.BitType -eq $Architecture -and $_.reboot -eq $Reboot}
    ...
    if (VerifyProduct $GUID) {
        Start-Process Msiexec.exe -ArgumentList $data.Unins_Param -Wait
        if (!(VerifyProduct $GUID)) {
