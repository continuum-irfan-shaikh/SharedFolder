...
func Test_partitionState_Len(t *testing.T) {
	...
	tests := []struct {
		...
		{name: "3 Size-1", want: 1, fields: fields{offset: []*offsetStatus{&offsetStatus{}}}},
		{name: "4 Size-3", want: 3, fields: fields{offset: []*offsetStatus{&offsetStatus{}, &offsetStatus{}, &offsetStatus{}}}},
	}
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			p := &partitionState{
...
func Test_partitionState_getCommitOffset(t *testing.T) {
	...
	tests := []struct {
		...
		},
		{
			...
			fields: fields{offset: []*offsetStatus{&offsetStatus{offset: 20, status: inProgress}}, lastCommitedOffset: -1, dirty: false},
		},
		{
			name: "3 Offset Commit having next completed", want: 20, want1: true, args: args{offset: 19},
			fields: fields{offset: []*offsetStatus{&offsetStatus{offset: 19, status: inProgress},
				&offsetStatus{offset: 20, status: completed}}, lastCommitedOffset: -1, dirty: false},
		},
		{
			name: "4 Offset Commit having previous inprogress", want: -1, want1: false, args: args{offset: 20},
			fields: fields{offset: []*offsetStatus{&offsetStatus{offset: 19, status: inProgress},
				&offsetStatus{offset: 20, status: inProgress}}, lastCommitedOffset: -1, dirty: false},
		},
		{
			name: "5 Offset Commit intermediate having previous inprogress", want: -1, want1: false, args: args{offset: 21},
			fields: fields{offset: []*offsetStatus{&offsetStatus{offset: 19, status: inProgress},
				&offsetStatus{offset: 22, status: inProgress}, &offsetStatus{offset: 20, status: completed},
				&offsetStatus{offset: 21, status: inProgress}}, lastCommitedOffset: -1, dirty: false},
		},
		{
...
func Test_partitionState_updateStatus(t *testing.T) {
	...
	tests := []struct {
		...
		{
			name: "2 Offset 0 / 21", args: args{offset: 0}, want: []*offsetStatus{&offsetStatus{offset: 21, status: inProgress}},
			fields: fields{offset: []*offsetStatus{&offsetStatus{offset: 21, status: inProgress}}, lastCommitedOffset: -1, dirty: false},
		},
		{
			name: "3 Offset 21 / 21", args: args{offset: 21}, want: []*offsetStatus{&offsetStatus{offset: 21, status: completed}},
			fields: fields{offset: []*offsetStatus{&offsetStatus{offset: 21, status: inProgress}}, lastCommitedOffset: -1, dirty: false},
		},
	}
	for _, tt := range tests {
...
func Test_partitionState_setOffset(t *testing.T) {
	...
	tests := []struct {
		...
		{
			name: "3 Assignement-1", args: args{offset: []*offsetStatus{&offsetStatus{offset: 21, status: inProgress}}},
			fields: fields{offset: []*offsetStatus{&offsetStatus{offset: 20, status: inProgress}}},
			want:   []*offsetStatus{&offsetStatus{offset: 21, status: inProgress}},
		},
		{
			name: "4 Assignement-2", args: args{offset: []*offsetStatus{&offsetStatus{offset: 22, status: completed}}},
			fields: fields{offset: []*offsetStatus{&offsetStatus{offset: 21, status: completed}}},
			want:   []*offsetStatus{&offsetStatus{offset: 22, status: completed}},
		},
	}
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
