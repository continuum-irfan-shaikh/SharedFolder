...
// Source: ../../usecases/scheduler/usecase.go
...
func (m *MockTaskExecutionRepo) ExecuteTasks(payload tasking.ExecutionPayload, partnerID, taskType string) error {
	ret := m.ctrl.Call(m, "ExecuteTasks", payload, partnerID, taskType)
	ret0, _ := ret[0].(error)
	return ret0
}

// ExecuteTasks indicates an expected call of ExecuteTasks
func (mr *MockTaskExecutionRepoMockRecorder) ExecuteTasks(payload, partnerID, taskType interface{}) *gomock.Call {
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "ExecuteTasks", reflect.TypeOf((*MockTaskExecutionRepo)(nil).ExecuteTasks), payload, partnerID, taskType)
}
...
func (m *MockDynamicGroupRepo) GetEndpointsByGroupIDs(targetIDs []string, createdBy, partnerID string, hasNOCAccess bool) ([]gocql.UUID, error) {
	ret := m.ctrl.Call(m, "GetEndpointsByGroupIDs", targetIDs, createdBy, partnerID, hasNOCAccess)
	ret0, _ := ret[0].([]gocql.UUID)
	ret1, _ := ret[1].(error)
	return ret0, ret1
}
...
func (mr *MockDynamicGroupRepoMockRecorder) GetEndpointsByGroupIDs(targetIDs, createdBy, partnerID, hasNOCAccess interface{}) *gomock.Call {
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "GetEndpointsByGroupIDs", reflect.TypeOf((*MockDynamicGroupRepo)(nil).GetEndpointsByGroupIDs), targetIDs, createdBy, partnerID, hasNOCAccess)
}
...
func (m *MockSiteRepo) GetEndpointsBySiteIDs(partnerID string, siteIDs []string) ([]gocql.UUID, error) {
	ret := m.ctrl.Call(m, "GetEndpointsBySiteIDs", partnerID, siteIDs)
	ret0, _ := ret[0].([]gocql.UUID)
	ret1, _ := ret[1].(error)
	return ret0, ret1
}
...
func (mr *MockSiteRepoMockRecorder) GetEndpointsBySiteIDs(partnerID, siteIDs interface{}) *gomock.Call {
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "GetEndpointsBySiteIDs", reflect.TypeOf((*MockSiteRepo)(nil).GetEndpointsBySiteIDs), partnerID, siteIDs)
}
...
func (m *MockAssetsClient) GetLocationByEndpointID(partnerID string, endpointID gocql.UUID) (*time.Location, error) {
	ret := m.ctrl.Call(m, "GetLocationByEndpointID", partnerID, endpointID)
...
func (mr *MockAssetsClientMockRecorder) GetLocationByEndpointID(partnerID, endpointID interface{}) *gomock.Call {
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "GetLocationByEndpointID", reflect.TypeOf((*MockAssetsClient)(nil).GetLocationByEndpointID), partnerID, endpointID)
}
...
// Encrypt mocks base method
func (m *MockAgentEncryptionService) Encrypt(endpointID gocql.UUID, credentials agent.Credentials) (agent.Credentials, error) {
	ret := m.ctrl.Call(m, "Encrypt", endpointID, credentials)
	ret0, _ := ret[0].(agent.Credentials)
	ret1, _ := ret[1].(error)
	return ret0, ret1
}
...
// Encrypt indicates an expected call of Encrypt
func (mr *MockAgentEncryptionServiceMockRecorder) Encrypt(endpointID, credentials interface{}) *gomock.Call {
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "Encrypt", reflect.TypeOf((*MockAgentEncryptionService)(nil).Encrypt), endpointID, credentials)
}
